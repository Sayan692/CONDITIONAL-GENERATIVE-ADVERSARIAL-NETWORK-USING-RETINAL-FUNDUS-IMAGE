...
if __name__=='__main__':
    ...
    #netD.load_state_dict(torch.load('D:/GAN/discriminator.weight'))
    ...
    for epoch in range(EPOCH_NUM):
        for i, data in enumerate(dataloader, 0):
            ...
            iters += 1
    print("........Running.......")
    torch.save(netG.state_dict(), 'D://GAN//generator.weight')
    torch.save(netD.state_dict(), 'D://GAN//discriminator.weight')